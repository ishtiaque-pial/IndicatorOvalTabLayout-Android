...
public class TabLayoutWithArrow extends HorizontalScrollView {
        ...
        private static final int DEFAULT_HEIGHT = 70; // dps
...
//                    canvas.drawPath(getTrianglePath(arrowSize), mSelectedIndicatorPaint);
                    ...
                    int rightPointX = leftPointX + arrowSize*4;
                    int bottomPointX = leftPointX + arrowSize;

                    int leftPointY = getHeight() - arrowSize;
                    int bottomPointY = getHeight();
                    RectF rect = new RectF(leftPointX, 130, rightPointX, 400);
                    canvas.drawOval(rect,mSelectedIndicatorPaint);
                    //canvas.drawCircle(bottomPointX, bottomPointY, 80, mSelectedIndicatorPaint);
                }
            }
            ...
            private Path getTrianglePath(int arrowSize) {
                ...
                int leftPointY = getHeight() - arrowSize;
                int bottomPointY = getHeight()-120;
